...
import com.jokku.jokeapp.domain.Interactor
...
class MainViewModel(
    ...
    sealed class State {
        ...
        abstract class Sight(private val text: String, @DrawableRes private val id: Int) : State() {
        ...
        class Initial(text: String, @DrawableRes private val id: Int) : Sight(text, id) {
            override val type = INITIAL
        }

        class Failed(text: String, @DrawableRes private val id: Int) : Sight(text, id) {
